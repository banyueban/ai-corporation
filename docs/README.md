...
| 事实                                 | 唯一权威来源                                                     |
| ------------------------------------ | ---------------------------------------------------------------- |
| Pi 重启后的产品方向和首版体验原则   | [产品重启说明](01-product/Product-Reboot.md)                     |
| 仍与重启方向一致的既有产品要求       | [PRD](01-product/PRD.md)                                         |
...
| 为快速交付而延期、未来仍需补齐的能力 | [简化与后续增强清单](06-engineering/Deferred-Enhancements.md)    |
...
| 分组           | 角色     | 文档                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 产品与架构     | 规范性   | [产品重启说明](01-product/Product-Reboot.md)、[PRD](01-product/PRD.md)、[Technical Design](02-architecture/Technical-Design.md)、[Domain Model](02-architecture/Domain-Model.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 核心引擎       | 规范性   | [Agent Runtime](03-core/Agent-Runtime.md)、[Skill Runtime](03-core/Skill-Runtime.md)、[Task Engine](03-core/Task-Engine.md)、[Organization](03-core/Organization-Engine.md)、[Scheduler](03-core/Scheduler.md)、[Evaluation](03-core/Evaluation-Engine.md)、[Artifact](03-core/Artifact-System.md)、[Memory](03-core/Memory-System.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 协议           | 规范性   | [Pi Company](04-protocols/Pi-Company-Protocol.md)、[Agent](04-protocols/Agent-Protocol.md)、[Task](04-protocols/Task-Protocol.md)、[Artifact](04-protocols/Artifact-Protocol.md)、[Corporation](04-protocols/Corporation-Protocol.md)、[Corporation State](04-protocols/Corporation-State-Protocol.md)、[Goal Contract](04-protocols/Goal-Contract-Protocol.md)、[Goal Engine](04-protocols/Goal-Engine-Protocol.md)、[Planner](04-protocols/Planner-Protocol.md)、[Plan Validation](04-protocols/Plan-Validation-Protocol.md)、[Plan Review](04-protocols/Plan-Review-Protocol.md)、[Event](04-protocols/Event-Protocol.md)、[Workspace](04-protocols/Workspace-Protocol.md)、[Provider Key Vault](04-protocols/Provider-Key-Vault-Protocol.md)、[Provider Connection Test](04-protocols/Provider-Connection-Test-Protocol.md)、[Provider Generation](04-protocols/Provider-Generation-Protocol.md)、[Native Health](04-protocols/Native-Health-RPC.md)；[Legacy Secure Store](04-protocols/Secure-Store-RPC.md) 只保留已移除方案的历史说明 |
...
| 开发路线       | 计划     | [MVP Plan](06-engineering/MVP-Plan.md)、[简化与后续增强清单](06-engineering/Deferred-Enhancements.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
