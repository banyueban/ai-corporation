...
- [ ] 21 当前验收候选提交的 Windows x64 与 macOS Apple Silicon CI 均通过工程检查、真实窗口、应用构建、打包程序专项旅程和安装包上传；两平台证据不互相替代。父提交的 macOS 已通过，Windows 因 JavaScript 首次安装只等待 5 秒而误报失败；当前测试修复尚待双平台 CI。
