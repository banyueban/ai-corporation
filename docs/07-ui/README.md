...
| UI-03 | 公司工作区 | 查看成员、常用工作区和结果；发起由最终负责人自动选协助员工的公司协作 |
| UI-04 | 员工与技能 | 创建员工、选择独立模型和多项 Skill、管理公司成员 |
| UI-05 | 员工任务 | 直接交代单员工任务，或查看公司协作的分工、交接、模型与工具过程，并验收或退回 |

旧 Goal Contract、Plan Review 和固定团队屏幕只保留兼容代码与历史数据，不在当前界面提供入口。
