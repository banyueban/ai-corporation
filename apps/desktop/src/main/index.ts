...
void app.whenReady().then(async () => {
  ...
  for (const [channel, action] of [
    ...
    [PI_TASK_START_COLLABORATION_IPC_CHANNEL, "startCollaboration"],
    [PI_TASK_CONTINUE_COLLABORATION_IPC_CHANNEL, "continueCollaboration"],
...
app.on("before-quit", (event) => {
  ...
  ipcMain.removeHandler(PI_TASK_START_COLLABORATION_IPC_CHANNEL);
  ipcMain.removeHandler(PI_TASK_CONTINUE_COLLABORATION_IPC_CHANNEL);
