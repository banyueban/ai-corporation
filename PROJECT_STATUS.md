...
| 当前任务单元 | M7-TU-01（进行中） |
| 总体状态 | Pi 单员工闭环和员工页布局修复已通过本地、Windows/macOS CI 与打包窗口验证，等待新安装包人工验收 |
| 最近更新 | 2026-08-15 |
| 下一检查点 | 用户人工验收包含员工页布局修复的新 Windows 安装包 |
...
- 用户对新安装包的人工验收尚未执行，因此 M7-TU-01 保持“进行中”。

## 7. 下一步

由用户使用新 Windows 安装包重点复验员工页布局，并完成单员工完整旅程人工验收。人工验收通过前不得关闭 M7-TU-01 或 Milestone 7。
